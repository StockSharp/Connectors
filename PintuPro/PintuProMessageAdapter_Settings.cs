...
/// <summary>
/// The message adapter for Pintu Pro.
/// </summary>
[MediaIcon(Media.MediaNames.pintupro)]
[Doc("topics/api/connectors/crypto_exchanges/pintu_pro.html")]
[Display(
...
[OrderCondition(typeof(PintuProOrderCondition))]
public partial class PintuProMessageAdapter : MessageAdapter, IKeySecretAdapter
{
    private const string _defaultRestEndpoint =
        "https://api.uat.pintupro.com";
    private const string _defaultWebSocketEndpoint =
        "wss://stream.uat.pintupro.com";
