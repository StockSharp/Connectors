...
static class ZeroXExtensions
{
	...
	public static string GetDefaultRpcEndpoint(this ZeroXChains chain)
		=> chain switch
		{
			ZeroXChains.Ethereum =>
				"https://ethereum-rpc.publicnode.com",
			ZeroXChains.Optimism => "https://mainnet.optimism.io",
			ZeroXChains.Bnb => "https://bsc-dataseed.binance.org",
			ZeroXChains.Polygon =>
				"https://polygon-bor-rpc.publicnode.com",
			ZeroXChains.Base => "https://mainnet.base.org",
			ZeroXChains.Arbitrum => "https://arb1.arbitrum.io/rpc",
			ZeroXChains.Avalanche =>
				"https://api.avax.network/ext/bc/C/rpc",
			ZeroXChains.Linea => "https://rpc.linea.build",
			_ => throw new ArgumentOutOfRangeException(nameof(chain), chain,
				"Unsupported 0x chain."),
		};

	public static string GetDefaultMarkets(this ZeroXChains chain)
		=> chain switch
		{
			ZeroXChains.Ethereum =>
	...
	public static string GetNativeSymbol(this ZeroXChains chain)
		=> chain switch
		{
			ZeroXChains.Ethereum or ZeroXChains.Optimism or
				ZeroXChains.Base or ZeroXChains.Arbitrum or
				ZeroXChains.Linea => "ETH",
			ZeroXChains.Bnb => "BNB",
			ZeroXChains.Polygon => "POL",
			ZeroXChains.Avalanche => "AVAX",
			_ => throw new ArgumentOutOfRangeException(nameof(chain), chain,
				"Unsupported 0x chain."),
		};
	...
	public static SecurityId ToStockSharp(this ZeroXMarket market)
		=> new()
		{
