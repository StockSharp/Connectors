...
partial class GopaxMessageAdapter
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="GopaxMessageAdapter"/>.
	/// </summary>
	/// <param name="transactionIdGenerator">Transaction id generator.</param>
	public GopaxMessageAdapter(IdGenerator transactionIdGenerator)
		: base(transactionIdGenerator)
	{
		HeartbeatInterval = TimeSpan.FromSeconds(1);
		BalanceCheckInterval = TimeSpan.FromSeconds(3);
	...
	/// <inheritdoc />
	public override string[] AssociatedBoards => [BoardCodes.Gopax];

#if !NO_LICENSE
	/// <inheritdoc />
	public override string FeatureName => nameof(Gopax);
#endif
	...
	protected override async ValueTask ConnectAsync(ConnectMessage connectMsg, CancellationToken cancellationToken)
	{
...
#if !NO_LICENSE
		var msg = await nameof(Gopax).ValidateLicenseAsync(component: GetType(), cancellationToken: cancellationToken);
		if (!msg.IsEmpty())
		...
		_httpClient = new HttpClient(Key, Secret, Address) { Parent = this };
