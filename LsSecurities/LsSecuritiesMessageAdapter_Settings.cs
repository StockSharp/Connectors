...
public partial class LsSecuritiesMessageAdapter : MessageAdapter, IDemoAdapter
{
	/// <summary>Application key issued by LS Securities.</summary>
	[Display(ResourceType = typeof(LocalizedStrings), Name = LocalizedStrings.LsSecuritiesAppKeyKey,
	...
	[Display(ResourceType = typeof(LocalizedStrings), Name = LocalizedStrings.LsSecuritiesAppSecretKey,
