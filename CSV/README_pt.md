...
O **conector CSV** conecta o StockSharp a uma fonte de dados configurável. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.
...
Campos, instrumentos e períodos disponíveis dependem da fonte de dados configurada.
