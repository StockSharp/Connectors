...
public class EtoroOrderCondition : OrderCondition
{
	...
	[DataMember]
	[Display(ResourceType = typeof(LocalizedStrings), Name = LocalizedStrings.SettlementKey,
	...
	[Display(ResourceType = typeof(LocalizedStrings), Name = LocalizedStrings.ModeKey,
		GroupName = LocalizedStrings.VolumeKey, Order = 2)]
	...
	[Display(ResourceType = typeof(LocalizedStrings), Name = LocalizedStrings.CurrencyKey,
		GroupName = LocalizedStrings.VolumeKey, Order = 3)]
	...
	[Display(ResourceType = typeof(LocalizedStrings), Name = LocalizedStrings.TakeProfitKey,
		GroupName = LocalizedStrings.LimitKey, Order = 5)]
	...
	[Display(ResourceType = typeof(LocalizedStrings), Name = LocalizedStrings.TrailingKey,
		GroupName = LocalizedStrings.StopKey, Order = 6)]
