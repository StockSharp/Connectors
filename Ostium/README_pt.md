...
O **conector Ostium** conecta o StockSharp a um protocolo de negociação e liquidez on-chain. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.
...
Redes, pools, instrumentos e funções de transação disponíveis dependem de Ostium, dos serviços RPC ou de indexação e das permissões da carteira.
