...
Der **DXtrade-Konnektor** verbindet StockSharp mit einem Forex-/CFD-Broker oder einer Handelsplattform. Er übersetzt anbieterspezifische Daten und Vorgänge in das einheitliche StockSharp-Nachrichtenmodell, sodass Anwendungen dieselben Abonnements und Abläufe für verschiedene Handelsplätze verwenden können.

## Wichtige Funktionen

- Typische Abdeckung: Forex und CFDs.
...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von DXtrade, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.
