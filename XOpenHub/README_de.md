# X Open Hub-Konnektor
[English](README.md) | [Русский](README_ru.md) | [中文](README_zh.md) | [Español](README_es.md) | [Português](README_pt.md) | [日本語](README_ja.md)

Der **X Open Hub-Konnektor** verbindet StockSharp mit einem Forex-/CFD-Broker oder einer Handelsplattform. Er übersetzt anbieterspezifische Daten und Vorgänge in das einheitliche StockSharp-Nachrichtenmodell, sodass Anwendungen dieselben Abonnements und Abläufe für verschiedene Handelsplätze verwenden können.
...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von X Open Hub, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.
