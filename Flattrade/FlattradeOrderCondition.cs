...
/// <summary>Flattrade-specific order condition.</summary>
[DataContract]
[Serializable]
public class FlattradeOrderCondition : OrderCondition
{
	...
	[DataMember]
	public FlattradeProducts? Product
	{
		get => Parameters.TryGetValue(_product)?.To<FlattradeProducts?>();
	...
	/// <summary>Client remarks echoed by Flattrade.</summary>
	[DataMember]
