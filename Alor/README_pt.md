...
O **conector Alor** conecta o StockSharp a uma corretora ou serviço de negociação para os mercados russos. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.
...
Instrumentos, profundidade de dados, permissões de negociação, limites e disponibilidade dependem de Alor, do plano de API e da conta conectada.
