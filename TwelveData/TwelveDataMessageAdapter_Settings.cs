...
[Display(ResourceType = typeof(LocalizedStrings), Name = LocalizedStrings.TwelveDataKey,
...
public partial class TwelveDataMessageAdapter : MessageAdapter, ITokenAdapter
{
	...
	[Display(Name = "WebSocket address", Description = "Twelve Data real-time price endpoint.",
	...
	[Display(Name = "Country", Description = "Country filter for stock and ETF reference data.",
		GroupName = "Market data", Order = 3)]
	[BasicSetting]
	public string Country { get; set; } = "United States";

	/// <summary>Optional exchange used to narrow stock and ETF lookup.</summary>
	[Display(Name = "Stock exchange", Description = "Optional stock and ETF exchange filter.",
		GroupName = "Market data", Order = 4)]
	public string StockExchange { get; set; }

	/// <summary>Optional MIC used to narrow stock and ETF lookup.</summary>
	[Display(Name = "Stock MIC", Description = "Optional market identifier code for stock and ETF lookup.",
	...
	[Display(Name = "Crypto exchange", Description = "Optional cryptocurrency exchange filter.",
		GroupName = "Market data", Order = 6)]
	public string CryptoExchange { get; set; }

	/// <summary>Historical-price adjustment policy.</summary>
	[Display(Name = "Adjustment", Description = "Split and dividend adjustment for historical candles.",
	...
	[Display(Name = "Extended hours", Description = "Include eligible US pre-market and post-market data.",
