...
El **conector de RSS** conecta StockSharp con un servicio de noticias financieras y datos de eventos. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de RSS, del plan de API y de la cuenta conectada.
