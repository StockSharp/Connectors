...
El **conector de Bitso** conecta StockSharp con un exchange centralizado de activos digitales. Traduce los datos y las operaciones específicos del proveedor al modelo unificado de mensajes de StockSharp, permitiendo usar las mismas suscripciones y flujos de trabajo en distintos mercados.
...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de Bitso, del plan de API y de la cuenta conectada.
