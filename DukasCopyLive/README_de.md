...
Der **Dukascopy-Konnektor** verbindet StockSharp mit einem Forex-/CFD-Broker oder einer Handelsplattform. Er übersetzt anbieterspezifische Daten und Vorgänge in das einheitliche StockSharp-Nachrichtenmodell, sodass Anwendungen dieselben Abonnements und Abläufe für verschiedene Handelsplätze verwenden können.
...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von Dukascopy, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.
