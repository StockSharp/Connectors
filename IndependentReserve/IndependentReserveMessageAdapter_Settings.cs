...
/// <summary>
/// The message adapter for Independent Reserve.
/// </summary>
[MediaIcon(Media.MediaNames.independentreserve)]
[Doc("topics/api/connectors/crypto_exchanges/independent_reserve.html")]
[Display(
...
[OrderCondition(typeof(IndependentReserveOrderCondition))]
public partial class IndependentReserveMessageAdapter : MessageAdapter,
	IKeySecretAdapter
{
	private const string _defaultRestEndpoint =
		"https://api.independentreserve.com";
	private const string _defaultWebSocketEndpoint =
		"wss://websockets.independentreserve.com";

	/// <summary>
	/// Supported historical candle time frames.
	/// </summary>
	public static IEnumerable<TimeSpan> AllTimeFrames =>
		IndependentReserveExtensions.TimeFrames;
