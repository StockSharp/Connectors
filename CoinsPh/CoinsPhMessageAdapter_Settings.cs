...
/// <summary>
/// The message adapter for Coins.ph.
/// </summary>
[MediaIcon(Media.MediaNames.coinsph)]
[Doc("topics/api/connectors/crypto_exchanges/coins_ph.html")]
[Display(
...
[OrderCondition(typeof(CoinsPhOrderCondition))]
public partial class CoinsPhMessageAdapter : MessageAdapter, IKeySecretAdapter
{
	private const string _defaultRestEndpoint = "https://api.pro.coins.ph";
	private const string _defaultWebSocketEndpoint = "wss://wsapi.pro.coins.ph";

	/// <summary>
	/// Supported candle time frames.
	/// </summary>
	public static IEnumerable<TimeSpan> AllTimeFrames => CoinsPhExtensions.TimeFrames;
