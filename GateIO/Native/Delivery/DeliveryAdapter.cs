...
class DeliveryAdapter : NativeAdapter
{
	...
	public DeliveryAdapter(GateIOMessageAdapter adapter, Authenticator authenticator)
		: base(authenticator, adapter.TransactionIdGenerator, BoardCodes.GateIODelivery, SecurityTypes.Future)
	{
