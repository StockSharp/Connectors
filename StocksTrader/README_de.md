# StocksTrader-Konnektor
[English](README.md) | [Русский](README_ru.md) | [中文](README_zh.md) | [Español](README_es.md) | [Português](README_pt.md) | [日本語](README_ja.md)

Der **StocksTrader-Konnektor** verbindet StockSharp mit einem Forex-/CFD-Broker oder einer Handelsplattform. Er übersetzt anbieterspezifische Daten und Vorgänge in das einheitliche StockSharp-Nachrichtenmodell, sodass Anwendungen dieselben Abonnements und Abläufe für verschiedene Handelsplätze verwenden können.

## Wichtige Funktionen

- Typische Abdeckung: Aktien, Forex und CFDs, Rohstoffe.
...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von StocksTrader, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.
