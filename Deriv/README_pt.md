...
O **conector Deriv** conecta o StockSharp a uma corretora ou plataforma de Forex/CFD. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.

## Principais recursos

- Cobertura típica: opções, Forex e CFDs, commodities.
...
Instrumentos, profundidade de dados, permissões de negociação, limites e disponibilidade dependem de Deriv, do plano de API e da conta conectada.
