...
Der **Deriv-Konnektor** verbindet StockSharp mit einem Forex-/CFD-Broker oder einer Handelsplattform. Er übersetzt anbieterspezifische Daten und Vorgänge in das einheitliche StockSharp-Nachrichtenmodell, sodass Anwendungen dieselben Abonnements und Abläufe für verschiedene Handelsplätze verwenden können.

## Wichtige Funktionen

- Typische Abdeckung: Optionen, Forex und CFDs, Rohstoffe.
...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von Deriv, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.
