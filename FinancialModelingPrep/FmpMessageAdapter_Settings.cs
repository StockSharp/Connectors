...
[Display(ResourceType = typeof(LocalizedStrings), Name = LocalizedStrings.FinancialModelingPrepKey,
...
public partial class FmpMessageAdapter : MessageAdapter, ITokenAdapter
{
	/// <inheritdoc />
	...
	[Display(Name = "Stock WebSocket", Description = "FMP US equity realtime endpoint.",
	...
	[Display(Name = "Forex WebSocket", Description = "FMP forex realtime endpoint.",
	...
	[Display(Name = "Crypto WebSocket", Description = "FMP crypto realtime endpoint.",
	...
	[Display(Name = "Intraday time zone",
