...
/// <summary>
/// The message adapter for Luno Exchange.
/// </summary>
[MediaIcon(Media.MediaNames.luno)]
[Doc("topics/api/connectors/crypto_exchanges/luno.html")]
[Display(
...
[OrderCondition(typeof(LunoOrderCondition))]
public partial class LunoMessageAdapter : MessageAdapter, IKeySecretAdapter
{
	private const string _defaultRestEndpoint = "https://api.luno.com";
	private const string _defaultWebSocketEndpoint = "wss://ws.luno.com";

	/// <summary>
	/// Supported historical candle time frames.
	/// </summary>
	public static IEnumerable<TimeSpan> AllTimeFrames =>
		LunoExtensions.TimeFrames;
