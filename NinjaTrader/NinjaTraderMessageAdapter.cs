...
[OrderCondition(typeof(NinjaTraderOrderCondition))]
public partial class NinjaTraderMessageAdapter
{
	private NinjaTraderClient _httpClient;
	private NinjaTraderSocketClient _marketSocket;
	private NinjaTraderSocketClient _accountSocket;

	/// <summary>
	/// Initializes a new instance of the <see cref="NinjaTraderMessageAdapter"/>.
	/// </summary>
	public NinjaTraderMessageAdapter(IdGenerator transactionIdGenerator)
	...
	{
		if (_marketSocket != null)
			await _marketSocket.SendHeartbeat(cancellationToken);
		if (_accountSocket != null)
