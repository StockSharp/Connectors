...
O **conector ZB** conecta o StockSharp a uma integração legada com uma exchange de ativos digitais. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.
