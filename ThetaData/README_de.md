...
Der **ThetaData-Konnektor** verbindet StockSharp mit einem professionellen Markt- und Analysedienst. Er übersetzt anbieterspezifische Daten und Vorgänge in das einheitliche StockSharp-Nachrichtenmodell, sodass Anwendungen dieselben Abonnements und Abläufe für verschiedene Handelsplätze verwenden können.

## Wichtige Funktionen

- Typische Abdeckung: Aktien, Optionen, Indizes.
...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von ThetaData, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.
