...
public partial class CqgMessageAdapter : MessageAdapter, ILoginPasswordAdapter, ITokenAdapter
{
	...
	[Display(
		ResourceType = typeof(LocalizedStrings),
		Name = LocalizedStrings.CqgOneTimePasswordKey,
		Description = LocalizedStrings.CqgOneTimePasswordDescKey,
		GroupName = LocalizedStrings.ConnectionKey,
		Order = 2)]
	...
	[Display(
		...
		Description = LocalizedStrings.CqgAccessTokenDescKey,
		GroupName = LocalizedStrings.ConnectionKey,
		Order = 3)]
	...
	[Display(
		ResourceType = typeof(LocalizedStrings),
		Name = LocalizedStrings.CqgPrivateLabelKey,
		Description = LocalizedStrings.CqgPrivateLabelDescKey,
		GroupName = LocalizedStrings.ConnectionKey,
		Order = 4)]
	...
	[Display(
		ResourceType = typeof(LocalizedStrings),
		Name = LocalizedStrings.CqgClientIdKey,
		Description = LocalizedStrings.CqgClientIdDescKey,
		GroupName = LocalizedStrings.ConnectionKey,
		Order = 5)]
	...
	[Display(
		ResourceType = typeof(LocalizedStrings),
		Name = LocalizedStrings.CqgClientVersionKey,
		Description = LocalizedStrings.CqgClientVersionDescKey,
		GroupName = LocalizedStrings.ConnectionKey,
		Order = 6)]
	...
	[Display(
		ResourceType = typeof(LocalizedStrings),
		Name = LocalizedStrings.CqgEndpointKey,
		Description = LocalizedStrings.CqgEndpointDescKey,
		GroupName = LocalizedStrings.ConnectionKey,
		Order = 7)]
	...
	[Display(
		ResourceType = typeof(LocalizedStrings),
		Name = LocalizedStrings.CqgPortfolioKey,
		Description = LocalizedStrings.CqgPortfolioDescKey,
		GroupName = LocalizedStrings.ConnectionKey,
		Order = 8)]
	...
	[Display(
		ResourceType = typeof(LocalizedStrings),
		Name = LocalizedStrings.CqgCollapsingLevelKey,
		Description = LocalizedStrings.CqgCollapsingLevelDescKey,
		GroupName = LocalizedStrings.ConnectionKey,
		Order = 9)]
