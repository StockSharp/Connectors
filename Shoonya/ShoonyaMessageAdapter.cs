...
public partial class ShoonyaMessageAdapter
{
	...
	private ShoonyaRestClient _restClient;
	private ShoonyaSocketClient _socketClient;
	...
	/// <summary>Initializes a new instance of the <see cref="ShoonyaMessageAdapter"/>.</summary>
