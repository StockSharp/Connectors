...
class PusherClient : BaseLogReceiver
{
	...
	private class AccountClient(Authenticator authenticator, string address, PusherClient parent, WorkingTime workingTime) : BaseClient(2, address, parent, workingTime)
	{
        ...
        public ValueTask Sign(CancellationToken cancellationToken)
		{
			...
			var signature = _authenticator.Sign(RestSharp.Method.Get, "api.hbdm.com", "/linear-swap-notification", $"AccessKeyId={accessKey}&SignatureMethod={Authenticator.Method}&SignatureVersion={Authenticator.Version2}&Timestamp={timestamp.EncodeUrl().UrlEncodeToUpperCase()}");
	...
	// to get readable name after obfuscation
	public override string Name => nameof(Huobi) + "_" + nameof(Usdt) + "_" + nameof(PusherClient);
	...
	public PusherClient(Authenticator authenticator, string domain, WorkingTime workingTime)
	{
		...
		_feedClient = new MarketDataClient(0, $"wss://{_domain}/linear-swap-ws", this, workingTime);
		_accountClient = new AccountClient(authenticator, $"wss://{_domain}/linear-swap-notification", this, workingTime);
	}
	...
	{
		return _feedClient.SubscribeTicker(securityId.SecurityCode, new(id, true, securityId, MessageTypes.Level1Change), cancellationToken);
	}

	public ValueTask UnSubscribeTicker(SecurityId securityId, long id, CancellationToken cancellationToken)
	{
		return _feedClient.UnSubscribeTicker(securityId.SecurityCode, new(id, false, securityId, MessageTypes.Level1Change), cancellationToken);
	}

	public ValueTask SubscribeBest(SecurityId securityId, long id, CancellationToken cancellationToken)
	{
		return _feedClient.SubscribeBest(securityId.SecurityCode, new(id, true, securityId, MessageTypes.Level1Change, Level1Fields.BestBidPrice), cancellationToken);
	}

	public ValueTask UnSubscribeBest(SecurityId securityId, long id, CancellationToken cancellationToken)
	{
		return _feedClient.UnSubscribeBest(securityId.SecurityCode, new(id, false, securityId, MessageTypes.Level1Change, Level1Fields.BestBidPrice), cancellationToken);
	}

	public ValueTask SubscribeTrades(SecurityId securityId, long id, CancellationToken cancellationToken)
	{
		return _feedClient.SubscribeTrades(securityId.SecurityCode, new(id, true, securityId, MessageTypes.Execution, DataType.Ticks), cancellationToken);
	}

	public ValueTask UnSubscribeTrades(SecurityId securityId, long id, CancellationToken cancellationToken)
	{
		return _feedClient.UnSubscribeTrades(securityId.SecurityCode, new(id, false, securityId, MessageTypes.Execution, DataType.Ticks), cancellationToken);
	}
	...
	{
		return _feedClient.SubscribeOrderBook(securityId.SecurityCode, depth, new(id, true, securityId, MessageTypes.QuoteChange, depth), cancellationToken);
	}

	public ValueTask UnSubscribeOrderBook(SecurityId securityId, int depth, long id, CancellationToken cancellationToken)
	{
		return _feedClient.UnSubscribeOrderBook(securityId.SecurityCode, depth, new(id, false, securityId, MessageTypes.QuoteChange, depth), cancellationToken);
	}
	...
	{
		return _feedClient.RequestCandles(securityId.SecurityCode, timeFrame, from, to, new(id, null, securityId, MessageTypes.CandleTimeFrame, timeFrame), cancellationToken);
	}

	public ValueTask SubscribeCandles(SecurityId securityId, TimeSpan timeFrame, long id, CancellationToken cancellationToken)
	{
		return _feedClient.SubscribeCandles(securityId.SecurityCode, timeFrame, new(id, true, securityId, MessageTypes.CandleTimeFrame, timeFrame), cancellationToken);
	}

	public ValueTask UnSubscribeCandles(SecurityId securityId, TimeSpan timeFrame, long id, CancellationToken cancellationToken)
	{
		return _feedClient.UnSubscribeCandles(securityId.SecurityCode, timeFrame, new(id, false, securityId, MessageTypes.CandleTimeFrame, timeFrame), cancellationToken);
	}
	...
	{
		return _accountClient.UnSubscribeOrders(new(id, false, default, MessageTypes.OrderStatus), cancellationToken);
	}
