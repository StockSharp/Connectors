...
O **conector Tinkoff** conecta o StockSharp a uma corretora ou serviço de negociação para os mercados russos. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.

## Principais recursos

- Cobertura típica: ações, futuros, opções, Forex e CFDs, títulos e renda fixa.
...
Instrumentos, profundidade de dados, permissões de negociação, limites e disponibilidade dependem de Tinkoff, do plano de API e da conta conectada.
