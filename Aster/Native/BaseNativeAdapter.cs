...
abstract class BaseNativeAdapter(SecureString key, SecureString secret, string boardCode, SecurityTypes securityType, string sectionName) : BaseLogReceiver, INativeAdapter
{
