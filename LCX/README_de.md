...
Der **LCX-Konnektor** verbindet StockSharp mit einer zentralisierten Börse für digitale Vermögenswerte. Er übersetzt anbieterspezifische Daten und Vorgänge in das einheitliche StockSharp-Nachrichtenmodell, sodass Anwendungen dieselben Abonnements und Abläufe für verschiedene Handelsplätze verwenden können.

## Wichtige Funktionen

- Typische Abdeckung: digitale Vermögenswerte, Spotmärkte.
...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von LCX, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.
