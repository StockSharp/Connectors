...
public partial class WooXMessageAdapter : MessageAdapter, IKeySecretAdapter
{
	...
	/// </summary>
	[Display(ResourceType = typeof(LocalizedStrings), Name = LocalizedStrings.AppIdKey,
		Description = LocalizedStrings.AppIdKey, GroupName = LocalizedStrings.ConnectionKey, Order = 2)]
	[BasicSetting]
	...
	/// </summary>
	[Display(ResourceType = typeof(LocalizedStrings), Name = LocalizedStrings.HistoryKey,
