# Fugle Market Data API-Konnektor
[English](README.md) | [Русский](README_ru.md) | [中文](README_zh.md) | [Español](README_es.md) | [Português](README_pt.md) | [日本語](README_ja.md)

Der **Fugle Market Data API-Konnektor** verbindet StockSharp mit einem professionellen Markt- und Analysedienst. Er übersetzt anbieterspezifische Daten und Vorgänge in das einheitliche StockSharp-Nachrichtenmodell, sodass Anwendungen dieselben Abonnements und Abläufe für verschiedene Handelsplätze verwenden können.
...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von Fugle Market Data API, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.
