...
Der **SnapTrade-Konnektor** verbindet StockSharp mit einem Broker oder elektronischen Handelsplatz für Finanzmärkte. Er übersetzt anbieterspezifische Daten und Vorgänge in das einheitliche StockSharp-Nachrichtenmodell, sodass Anwendungen dieselben Abonnements und Abläufe für verschiedene Handelsplätze verwenden können.

## Wichtige Funktionen

- Typische Abdeckung: Aktien, Futures, Optionen, Anleihen und festverzinsliche Instrumente, Fonds und ETFs.
...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von SnapTrade, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.
