...
public class ZerodhaOrderCondition : OrderCondition
{
	...
	[Display(
		ResourceType = typeof(LocalizedStrings),
		Name = LocalizedStrings.ZerodhaOrderVarietyKey,
	...
	[Display(
		ResourceType = typeof(LocalizedStrings),
		Name = LocalizedStrings.ZerodhaDisclosedQuantityKey,
	...
	[Display(
		ResourceType = typeof(LocalizedStrings),
		Name = LocalizedStrings.ZerodhaValidityTtlKey,
	...
	[Display(
		ResourceType = typeof(LocalizedStrings),
		Name = LocalizedStrings.ZerodhaMarketProtectionKey,
	...
	[Display(
		ResourceType = typeof(LocalizedStrings),
		Name = LocalizedStrings.ZerodhaAutoSliceKey,
