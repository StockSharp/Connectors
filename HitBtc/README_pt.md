...
O **conector HitBTC** conecta o StockSharp a uma exchange centralizada de ativos digitais. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.
...
Instrumentos, profundidade de dados, permissões de negociação, limites e disponibilidade dependem de HitBTC, do plano de API e da conta conectada.
