...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von Talos, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.
