...
Los instrumentos, la profundidad de datos, los permisos de negociación, los límites y la disponibilidad dependen de Chainlink Data Streams, del plan de API y de la cuenta conectada.
