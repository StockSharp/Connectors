...
sealed class CoinTRAuthenticator
{
	private readonly string _key;
	private readonly string _secret;
	private readonly string _passphrase;

	public CoinTRAuthenticator(SecureString key, SecureString secret,
	...
	public string Sign(long timestamp, string method, string path,
		...
		=> CreateSignature(_secret, BuildPrehash(timestamp, method, path,
			query, body));

	public static string BuildPrehash(long timestamp, string method,
