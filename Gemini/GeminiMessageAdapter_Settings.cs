...
/// <summary>
/// The message adapter for Gemini.
/// </summary>
[MediaIcon(Media.MediaNames.gemini)]
[Doc("topics/api/connectors/crypto_exchanges/gemini.html")]
[Display(
...
[OrderCondition(typeof(GeminiOrderCondition))]
public partial class GeminiMessageAdapter : MessageAdapter, IKeySecretAdapter
{
	private const string _defaultRestEndpoint = "https://api.gemini.com";
	private const string _defaultWebSocketEndpoint = "wss://ws.gemini.com";

	/// <summary>
	/// Supported candle time-frames.
	/// </summary>
	public static IEnumerable<TimeSpan> AllTimeFrames => GeminiExtensions.TimeFrames;
	...
	/// <summary>
	/// Subaccount name used with a master API key for private REST snapshots.
	/// </summary>
	[Display(
		ResourceType = typeof(LocalizedStrings),
	...
	/// <summary>
	/// Cancel session orders when the WebSocket disconnects.
	/// </summary>
	[Display(
		ResourceType = typeof(LocalizedStrings),
		...
		Order = 3)]
	[BasicSetting]
	public bool IsCancelOnDisconnect { get; set; }
	...
	public override void Save(SettingsStorage storage)
	{
		...
		storage
			...
			.Set(nameof(IsCancelOnDisconnect), IsCancelOnDisconnect)
	...
	public override void Load(SettingsStorage storage)
	{
		...
		IsCancelOnDisconnect = storage.GetValue(nameof(IsCancelOnDisconnect),
		...
		WebSocketEndpoint = NormalizeEndpoint(storage.GetValue(nameof(WebSocketEndpoint),
