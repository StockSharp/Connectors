...
O **conector BitGo** conecta o StockSharp a um serviço institucional, de custódia ou liquidação de ativos digitais. Ele traduz dados e operações específicos do provedor para o modelo unificado de mensagens do StockSharp, permitindo usar as mesmas assinaturas e fluxos em diferentes mercados.
...
Instrumentos, profundidade de dados, permissões de negociação, limites e disponibilidade dependem de BitGo, do plano de API e da conta conectada.
