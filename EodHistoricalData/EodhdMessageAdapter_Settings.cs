...
[Display(ResourceType = typeof(LocalizedStrings), Name = LocalizedStrings.EodHistoricalDataKey,
...
public partial class EodhdMessageAdapter : MessageAdapter, ITokenAdapter, IAddressAdapter<Uri>
{
	...
	[Display(Name = "US trade WebSocket", Description = "EODHD US trade stream endpoint.",
	...
	[Display(Name = "US quote WebSocket", Description = "EODHD US quote stream endpoint.",
	...
	[Display(Name = "Forex WebSocket", Description = "EODHD forex quote stream endpoint.",
	...
	[Display(Name = "Crypto WebSocket", Description = "EODHD crypto trade stream endpoint.",
	...
	[Display(Name = "Delisted securities",
	...
	[Display(Name = "WebSocket symbol limit",
