...
public partial class MexcMessageAdapter
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="MexcMessageAdapter"/>.
	/// </summary>
	/// <param name="transactionIdGenerator">Transaction id generator.</param>
	public MexcMessageAdapter(IdGenerator transactionIdGenerator)
	...
	protected override async ValueTask ConnectAsync(ConnectMessage connectMsg, CancellationToken cancellationToken)
	{
		...
		if (Sections.Contains(MexcSections.Spot))
			addAdapter(new Native.Spot.SpotAdapter(this, _authenticator));

		if (Sections.Contains(MexcSections.Futures))
