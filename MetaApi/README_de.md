...
Der **MetaApi-Konnektor** verbindet StockSharp mit einem Forex-/CFD-Broker oder einer Handelsplattform. Er übersetzt anbieterspezifische Daten und Vorgänge in das einheitliche StockSharp-Nachrichtenmodell, sodass Anwendungen dieselben Abonnements und Abläufe für verschiedene Handelsplätze verwenden können.

## Wichtige Funktionen

- Typische Abdeckung: Aktien, Futures, Optionen, Forex und CFDs, Rohstoffe, Indizes.
...
Instrumente, Datentiefe, Handelsrechte, Limits und Verfügbarkeit werden von MetaApi, dem API-Tarif und den Berechtigungen des verbundenen Kontos bestimmt.
